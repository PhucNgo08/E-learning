...
# ➕ CREATE
# =====================================================
def create_course_category(category_name: str, description: str, db: Session):
...
# ✏️ UPDATE
# =====================================================
def update_course_category(category_id: str, category_name: str, description: str, db: Session):
...
# ❌ DELETE
# =====================================================
def delete_course_category(category_id: str, db: Session):
